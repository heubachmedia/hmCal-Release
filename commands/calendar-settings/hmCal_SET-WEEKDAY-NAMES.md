...
# hmCal_SET WEEKDAY NAMES

`hmCal_SET WEEKDAY NAMES(area;weekday names)`
...
The command ***hmCal_SET WEEKDAY NAMES*** sets all weekday names defined by the array *weekday names*. The array can be a string-array or a text-array.
...
hmCal_SET WEEKDAY NAMES(hmCal;$tt_weekdaynames)
```
