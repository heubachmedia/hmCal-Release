...
# hmCal_SET MONTH NAMES

`hmCal_SET MONTH NAMES(area;monthnames)`
...
The command ***hmCal_SET MONTH NAMES*** sets all monthnames defined by the array *monthnames*. The array can be a string-array or a text-array.
...
hmCal_SET MONTH NAMES(hmCal;$tt_monthnames)
```
