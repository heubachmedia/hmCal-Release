...
# hmCal_SET APPOINTMENT FORECOLOR

`hmCal_SET APPOINTMENT FORECOLOR(area;reference;red;green;blue)`
...
The command ***hmCal_SET APPOINTMENT FORECOLOR*** sets the foreground color of appointment, definied by the parameter *reference* to the RGB color defined by the color components *red*, *green* and *blue*. If you pass a *0* in the parameter *reference*, the command will be applied to all appointments. If you pass a *-1* in the parameter *reference*, the command will be applied to all new appointments.

<a id="nummer_00002"></a>

## Example

1. The following example sets the foreground color of an appointment to red:

```4d
hmCal_SET APPOINTMENT FORECOLOR(hmCal;1;0xFFFF;0;0)
```

2. The following example sets the foreground color of all appointments to red:

```4d
hmCal_SET APPOINTMENT FORECOLOR(hmCal;0;0xFFFF;0;0)
```
