...
var $vl_version; $vl_majorrversion; $vl_minorversion; $vl_revision : Integer
...
return String:C10($vl_majorrversion)+"."+String:C10($vl_minorversion)+"."+String:C10($vl_revision)
